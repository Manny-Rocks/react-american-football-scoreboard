  ...
  return (
    <div className="container">
      <section className="scoreboard">
        <div className="topRow">
          <div className="home">
            ...
            <div className="home__score">{state.home}</div>
          </div>
          <div className="timer">20:00</div>
          <div className="away">
            <h2 className="away__name">Tigers</h2>
            <div className="away__score">{state.away}</div>
          </div>
      ...
      <section className="buttons">
        ...
        <div>
          {/* <button className="quarter_button" onClick={() => setState({ ...state,quart:state.quart +1})}>Quarter</button> */}
        </div>
      </section>
    </div>
  );
